...
let names2: string[] = ["Albert", "Bobby", "Catharine", "Dominic"];

// Print each person's name by accessing each element in the list, one at a time.
for (let i = 0; i < names2.length; i++) {
    console.log(`\nHi, ${names2[i]}, Today, You have to reach airport at 09:30pm.`);
...
console.log(`\nHi, ${names3[0]}, Today, You have to reach airport at 09:30pm.`);
