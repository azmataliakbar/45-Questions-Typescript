...
// function describe albums parameters which return argument values
...
// calling function with arguments, 3 different albums
console.log("\n", make_album("Ali Zafar", "Jhoom", 15));
console.log("\n", make_album("Atif Aslam", "Doorie"));
console.log("\n", make_album("Nazia Hassan", "Disco Deewane", 10));
